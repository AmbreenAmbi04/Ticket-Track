            ...
            <img src="Images/Ticket Track Card Prototype.png" width="110px" height="90px" />
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarNavDropdown">
                            <ul class="navbar-nav mx-auto">
                                <li class="nav-item">
                                    <a id="home-link" class="nav-link" aria-current="page" href="index.html">
                                        <i class="bi bi-house-door"></i> Home
                                    </a>
                                </li>
                                <li class="nav-item dropdown">
                                    <a id="book-link" class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <li class="nav-item">
                                    <a id="routes-link" class="nav-link" href="routes.html">
                                        <i class="bi bi-map"></i> Routes
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="guide-link" class="nav-link" href="guides.php">
                            ...
                            <ul class="navbar-nav ms-auto" id="nav-user">
                                <li class="nav-item">
                                    <a id="login-link" class="nav-link custom-login-btn" href="login.html">
                                        Login
                                    </a>
                                </li>
                            </ul>
